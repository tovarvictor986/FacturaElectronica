<%@page import="com.model.FileCSV, java.util.*, java.text.DateFormat, java.text.SimpleDateFormat"%>
<%@page import="java.io.*,org.w3c.dom.*,javax.xml.parsers.*,javax.xml.transform.*, javax.xml.transform.dom.*,javax.xml.transform.stream.*"%>
<%!
//ESTA CLASE NO SE ESTA UTILIZANDO, SE USA LA .JAVA
public class CreateXML {		
	public void create(FileCSV fileXML, int i) throws Exception{
	    ...
	    try {
	      ...
	      //stsDianExtensions elemento
	        ...
	        stsInvoiceAuthorization.setTextContent(fileXML.getCbcIdentificationCode());
	      ...
	      //sts:AuthorizedInvoices elemento
	        ...
	        Element tsFrom = doc.createElement("ts:From");
	        stsAuthorizedInvoices.appendChild(tsFrom);
	        ...
	        //StreamResult result = new StreamResult(new File("C:/Users/vtovar/Documents/TXTtoXML/DATA/"+nameFile+i+".xml"));
	        StreamResult result = new StreamResult(new File("Documents/"+nameFile+".xml"));
	        //StreamResult result = new StreamResult(new File("C:/Users/vtovar/Documents/TXTtoXML/DATA_PRUEBA.xml"));
	        transformer.transform(source, result);	        
	             
	        //System.out.println("<h1>Documento Procesado</h1>");	        
	        //System.out.println("<a href='index.jsp'>regresar...</a>"); 
